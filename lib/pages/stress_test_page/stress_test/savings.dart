...
class StressTestSavingsPage extends StatefulWidget {
  const StressTestSavingsPage({super.key});

  @override
  State<StressTestSavingsPage> createState() => _StressTestSavingsPageState();
}

class _StressTestSavingsPageState extends State<StressTestSavingsPage> {
